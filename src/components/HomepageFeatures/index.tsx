...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Docusaurus was designed from the ground up to
        be easily installed and used to get your
  ...
  },
  {
    ...
    description: (
      <>
        ...
        we&apos;ll do the chores. Go ahead and move
  ...
  },
  {
    ...
    description: (
      <>
        Extend or customize your website layout by
        reusing React. Docusaurus can be extended while
